#!/bin/bash
#SBATCH --job-name=ROMS-column-backwards
#SBATCH --ntasks=16
...
for number_particles in \
        10 30 100 300 1000 2000 3000 5000 7000 10000 12000 15000 20000 30000 100000 300000 1000000; do
    for release_zone in test_1500; do
        ...
        # run for single notebook and put into background
            ...
            && papermill --cwd notebooks \
                notebooks/2023-06-09_test-ROMS-column-backwards.ipynb \
                notebooks_executed/2023-06-09_test-ROMS-column_S-${release_zone}_N-${number_particles}-20090301_RT-42-backwards.ipynb \
