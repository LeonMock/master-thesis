...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            ...
            notebooks_executed/preliminary-experiment/2023-09-29_ROMSchild-track10_S-test_1500_N-100000-2009-${start_month}-${start_day}_RT-42.ipynb \
