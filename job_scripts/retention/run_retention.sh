...
mkdir -p notebooks_executed/preliminary-experiment/retention/10mins
...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            notebooks/retention/2023-09-04_retention-split.ipynb \
            notebooks_executed/preliminary-experiment/retention/10mins/2023-09-04_retention-split-2009-${start_month}-${start_day}.ipynb \
