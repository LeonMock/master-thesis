#!/bin/bash
#SBATCH --job-name=retention-depending-on-depth
#SBATCH --ntasks=73
...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            notebooks/retention/2023-10-21_retention-depending-on-depth.ipynb \
            notebooks_executed/preliminary-experiment/retention/2023-10-021_retention-depending-on-depth-2009-${start_month}-${start_day}.ipynb \
