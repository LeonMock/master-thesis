...
mkdir -p notebooks_executed/preliminary-experiment/retention/tiefenunabhängig
...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            notebooks/retention/2023-10-24_retention-tides-depending-on-depth.ipynb \
            notebooks_executed/tides/retention/tiefenunabhängig/2023-10-24_retention-2009-${start_month}-${start_day}.ipynb \
