...
mkdir -p notebooks_executed/preliminary-experiment/retention/10mins/tides
...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            ...
            notebooks_executed/preliminary-experiment/retention/10mins/tides/2023-10-04_retention-2009-${start_month}-${start_day}.ipynb \
