#!/bin/bash
#SBATCH --job-name=INALT-3h-tides
#SBATCH --ntasks=16
...
mkdir -p notebooks_executed/tides
...
for start_month in 1; do
    ...
    # run for single notebook and put into background
        ...
        && papermill --cwd notebooks \
            notebooks/3h-output/2023-10-02_INALT-tides.ipynb \
            notebooks_executed/3h-output/2023-10-02_INALT-track_N-100000-2009-${start_month}-${start_day}_RT-42.ipynb \
