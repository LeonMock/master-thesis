    ...
    for release_zone in test_1500; do
        ...
        # run for single notebook and put into background
            ...
            && papermill --cwd notebooks \
                notebooks/2023-06-02_test-ROMSchild-column.ipynb \
                notebooks_executed/2023-06-02_test-ROMSchild-column_S-${release_zone}_N-${number_particles}-20090301_RT-42.ipynb \
